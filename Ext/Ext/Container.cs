...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\Container.js</jssource>
	public class Container : Ext.BoxComponent {
		...
		/// <returns></returns>
		public Container(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Container(System.String config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Container(object config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static Container prototype { get { return S_<Container>(); } set { S_(value); } }
		...
		/// </summary>
		public System.String layout { get { return _<System.String>(); } set { _(value); } }
		...
		/// <returns>Ext.Component</returns>
		public virtual void add(Ext.Component component) { _(component); }
		...
		/// <param name="component">The Component to add.<br><br></param>
		/// <returns>Ext.Component</returns>
		public virtual void add(object component) { _(component); }
		...
		/// <returns>Ext.Component</returns>
		public virtual void insert(double index, Ext.Component component) { _(index, component); }
		...
		/// <returns></returns>
		public virtual void remove(Component component) { _(component); }
		...
		/// <returns></returns>
		public virtual void remove(Component component, bool autoDestroy) { _(component, autoDestroy); }
		...
		/// <param name="component">The component reference or id to remove.</param>
		/// <returns></returns>
		public virtual void remove(System.String component) { _(component); }
		...
		/// <param name="autoDestroy">(optional) True to automatically invoke the removed Component's {@link Ext.Component#destroy} function.</param>
		/// <returns></returns>
		public virtual void remove(System.String component, bool autoDestroy) { _(component, autoDestroy); }
		...
		/// <returns>Ext.Component</returns>
		public virtual void getComponent(System.String id) { _(id); }

		/// <summary>Gets a direct child Component by id, or by index.</summary>
		/// <param name="id">or index of child Component to return.</param>
		/// <returns>Ext.Component</returns>
		public virtual void getComponent(double id) { _(id); }
		...
		/// <returns></returns>
		public virtual void doLayout(bool shallow) { _(shallow); }
		...
		/// <param name="id"></param>
		/// <returns>Ext.Component</returns>
		public virtual void findById(System.String id) { _(id); }
		...
		/// <returns>Array</returns>
		public virtual void findByType(System.String xtype) { _(xtype); }

		/// <summary>Find a component under this container at any level by xtype or class</summary>
		/// <param name="xtype">The xtype string for a component, or the class of the component directly</param>
		/// <returns>Array</returns>
		public virtual void findByType(object xtype) { _(xtype); }
		...
		/// <returns>Array</returns>
		public virtual void find(System.String prop) { _(prop); }

		/// <summary>Find a component under this container at any level by property</summary>
		/// <param name="prop"></param>
		/// <param name="value"></param>
		/// <returns>Array</returns>
		public virtual void find(System.String prop, System.String value) { _(prop, value); }
		...
		/// <returns>Array</returns>
		public virtual void findBy(Delegate fcn) { _(fcn); }
		...
		/// <returns>Array</returns>
		public virtual void findBy(Delegate fcn, object scope) { _(fcn, scope); }
	...
	[JsAnonymous]
	public class ContainerConfig : DotWeb.Client.JsAccessible {
