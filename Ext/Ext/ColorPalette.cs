...
namespace Ext {
	...
	///     </code></pre>
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\ColorPalette.js</jssource>
	public class ColorPalette : Ext.Component {

		/// <summary>Create a new ColorPalette</summary>
		/// <returns></returns>
		public ColorPalette() { C_(); }
		/// <summary>Create a new ColorPalette</summary>
		/// <param name="config">The config object</param>
		/// <returns></returns>
		public ColorPalette(object config) { C_(config); }
		/// <summary>
		...
		/// <returns></returns>
		public ColorPalette(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public ColorPalette(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static ColorPalette prototype { get { return S_<ColorPalette>(); } set { S_(value); } }
		...
		public System.String tpl { get { return _<System.String>(); } set { _(value); } }
		...
		/// </summary>
		public System.String value { get { return _<System.String>(); } set { _(value); } }

		/// <summary>If set to true then reselecting a color that is already selected fires the {@link #select} event</summary>
		public bool allowReselect { get { return _<bool>(); } set { _(value); } }
		...
		///     </code></pre>
		/// </summary>
		public System.Array colors { get { return _<System.Array>(); } set { _(value); } }
		...
		/// <returns></returns>
		public virtual void select(System.String color) { _(color); }
	...
	[JsAnonymous]
	public class ColorPaletteConfig : DotWeb.Client.JsAccessible {
		/// <summary> An existing XTemplate instance to be used in place of the default template for rendering the component.</summary>
		public System.String tpl { get; set; }
