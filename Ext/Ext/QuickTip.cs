...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\tips\QuickTip.js</jssource>
	public class QuickTip : Ext.ToolTip {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public QuickTip(System.String config) { C_(config); }
		...
		/// <returns></returns>
		public virtual void unregister(System.String el) { _(el); }
	...
	[JsAnonymous]
	public class QuickTipConfig : DotWeb.Client.JsAccessible {
		/// <summary> The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document).</summary>
		...
		public System.Array mouseOffset { get; set; }
