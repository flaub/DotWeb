...
namespace Ext {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\tips\QuickTip.js</jssource>
    [Native]
    public class QuickTip : Ext.ToolTip {
        ...
        /// <returns></returns>
        public QuickTip(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public QuickTip(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public QuickTip(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static QuickTip prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.ToolTip superclass { get { return null; } set { } }

        /// <summary>The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document).</summary>
        public object target { get { return null; } set { } }

        /// <summary>True to automatically use the element's DOM title value if available (defaults to false).</summary>
        public bool interceptTitles { get { return false; } set { } }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void register() { return ; }
        ...
        /// <returns></returns>
        public virtual void register(object config) { return ; }

        /// <summary>Removes this quick tip from its element and destroys it.</summary>
        /// <returns></returns>
        public virtual void unregister() { return ; }

        /// <summary>Removes this quick tip from its element and destroys it.</summary>
        /// <param name="el">The element from which the quick tip is to be removed.</param>
        /// <returns></returns>
        public virtual void unregister(System.String el) { return ; }

        /// <summary>Removes this quick tip from its element and destroys it.</summary>
        /// <param name="el">The element from which the quick tip is to be removed.</param>
        /// <returns></returns>
        public virtual void unregister(DOMElement el) { return ; }

        /// <summary>Removes this quick tip from its element and destroys it.</summary>
        /// <param name="el">The element from which the quick tip is to be removed.</param>
        /// <returns></returns>
        public virtual void unregister(Element el) { return ; }
