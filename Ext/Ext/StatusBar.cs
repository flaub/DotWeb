...
namespace Ext {
    ...
    ///     </code></pre>
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\StatusBar.js</jssource>
    [Native]
    public class StatusBar : Ext.ToolbarClass {
        ...
        /// <returns></returns>
        public StatusBar(object config) {}
        /// <summary>Creates a new StatusBar</summary>
        /// <param name="config">A config object</param>
        /// <returns></returns>
        public StatusBar(System.Array config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public StatusBar(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public StatusBar(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static StatusBar prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.ToolbarClass superclass { get { return null; } set { } }
        ...
        ///     </code></pre>
        /// </summary>
        public System.String statusAlign { get { return null; } set { } }

        /// <summary>
        ///     The default {@link #text} value.  This will be used anytime the status bar is cleared with the
        ///     <tt>useDefaults:true</tt> option (defaults to '').
        /// </summary>
        public System.String defaultText { get { return null; } set { } }

        /// <summary>
        ///     The default {@link #iconCls} value (see the iconCls docs for additional details about customizing the icon).
        ///     This will be used anytime the status bar is cleared with the <tt>useDefaults:true</tt> option (defaults to '').
        /// </summary>
        public System.String defaultIconCls { get { return null; } set { } }
        ...
        /// </summary>
        public System.String busyIconCls { get { return null; } set { } }
        ...
        /// </summary>
        public System.String busyText { get { return null; } set { } }
        ...
        /// </summary>
        public double autoClear { get { return 0; } set { } }
        ...
        public virtual Ext.StatusBar setStatus() { return null; }
        ...
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setStatus(object config) { return null; }
        ...
        /// <param name="config">A config object specifying what status to set, or a string assumed</param>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setStatus(System.String config) { return null; }
        ...
        /// </summary>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar clearStatus() { return null; }
        ...
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar clearStatus(object config) { return null; }

        /// <summary>Convenience method for setting the status text directly.  For more flexible options see {@link #setStatus}.</summary>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setText() { return null; }

        /// <summary>Convenience method for setting the status text directly.  For more flexible options see {@link #setStatus}.</summary>
        /// <param name="text">(optional) The text to set (defaults to '')</param>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setText(System.String text) { return null; }
        ...
        /// </summary>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setIcon() { return null; }
        ...
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar setIcon(System.String iconCls) { return null; }
        ...
        /// </summary>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar showBusy() { return null; }
        ...
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar showBusy(object config) { return null; }
        ...
        /// <param name="config">(optional) A config object in the same format supported by {@link #setStatus}, or a</param>
        /// <returns>Ext.StatusBar</returns>
        public virtual Ext.StatusBar showBusy(System.String config) { return null; }
