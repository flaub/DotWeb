...
namespace Ext.grid {
	...
	///     </ul>
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\grid\GridPanel.js</jssource>
	public class GridPanel : Ext.Panel {
		...
		/// <returns></returns>
		public GridPanel(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public GridPanel(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public GridPanel(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static GridPanel prototype { get { return S_<GridPanel>(); } set { S_(value); } }
		...
		public object cm { get { return _<object>(); } set { _(value); } }

		/// <summary>The {@link Ext.grid.ColumnModel} to use when rendering the grid (required).</summary>
		public object colModel { get { return _<object>(); } set { _(value); } }

		/// <summary>Shorthand for {@link #selModel}.</summary>
		public object sm { get { return _<object>(); } set { _(value); } }
		...
		public System.Array columns { get { return _<System.Array>(); } set { _(value); } }
		...
		public bool disableSelection { get { return _<bool>(); } set { _(value); } }

		/// <summary>False to turn off column reordering via drag drop (defaults to true).</summary>
		public bool enableColumnMove { get { return _<bool>(); } set { _(value); } }

		/// <summary>False to turn off column resizing for the whole grid (defaults to true).</summary>
		public bool enableColumnResize { get { return _<bool>(); } set { _(value); } }
		...
		public object viewConfig { get { return _<object>(); } set { _(value); } }

		/// <summary>True to hide the grid's header (defaults to false).</summary>
		public bool hideHeaders { get { return _<bool>(); } set { _(value); } }

		/// <summary>
		///     Configures the text in the drag proxy (defaults to "{0} selected row(s)").
		///     {0} is replaced with the number of selected rows.
		/// </summary>
		public System.String ddText { get { return _<System.String>(); } set { _(value); } }

		/// <summary>The minimum width a column can be resized to. Defaults to 25.</summary>
		public double minColumnWidth { get { return _<double>(); } set { _(value); } }
		...
		/// </summary>
		/// <returns></returns>
		public virtual void reconfigure() { _(); }
		...
		/// <returns></returns>
		public virtual void reconfigure(Ext.data.Store store) { _(store); }
		...
		/// <returns></returns>
		public virtual void reconfigure(Ext.data.Store store, Ext.grid.ColumnModel colModel) { _(store, colModel); }

		/// <summary>Returns the grid's underlying element.</summary>
		/// <returns>Element</returns>
		public virtual void getGridEl() { _(); }
	...
	[JsAnonymous]
	public class GridPanelConfig : DotWeb.Client.JsAccessible {
