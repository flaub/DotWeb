...
namespace Ext.grid {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\grid\EditorGrid.js</jssource>
    [Native]
    public class EditorGridPanel : Ext.grid.GridPanel {
        ...
        /// <returns></returns>
        public EditorGridPanel(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public EditorGridPanel(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public EditorGridPanel(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static EditorGridPanel prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.grid.GridPanel superclass { get { return null; } set { } }
        ...
        /// <returns></returns>
        public virtual void startEditing() { return ; }

        /// <summary>Starts editing the specified for the specified row/column</summary>
        /// <param name="rowIndex"></param>
        /// <returns></returns>
        public virtual void startEditing(double rowIndex) { return ; }

        /// <summary>Starts editing the specified for the specified row/column</summary>
        /// <param name="rowIndex"></param>
        /// <param name="colIndex"></param>
        /// <returns></returns>
        public virtual void startEditing(double rowIndex, double colIndex) { return ; }

        /// <summary>Stops any active editing</summary>
        /// <returns></returns>
        public virtual void stopEditing() { return ; }

        /// <summary>Stops any active editing</summary>
        /// <param name="cancel">(optional) True to cancel any changes</param>
        /// <returns></returns>
        public virtual void stopEditing(bool cancel) { return ; }
