...
namespace Ext.grid {
    ...
    public class PropertyColumnModel : Ext.grid.ColumnModel {
        ...
        /// <returns></returns>
        public PropertyColumnModel(object grid) {}
        /// <summary></summary>
        /// <param name="grid">The grid this store will be bound to</param>
        /// <param name="source">The source data config object</param>
        /// <returns></returns>
        public PropertyColumnModel(object grid, object source) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static PropertyColumnModel prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.grid.ColumnModel superclass { get { return null; } set { } }
