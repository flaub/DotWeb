...
namespace Ext.tree {
    ...
    ///     as the editor field.
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\tree\TreeEditor.js</jssource>
    [Native]
    public class TreeEditor : Ext.Editor {
        ...
        /// <returns></returns>
        public TreeEditor(Ext.Element config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public TreeEditor(System.String config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public TreeEditor(object config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static TreeEditor prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.Editor superclass { get { return null; } set { } }
        ...
        /// </summary>
        public double editDelay { get { return 0; } set { } }

        /// <summary>The tree node this editor is bound to. Read-only.</summary>
        public Ext.tree.TreeNode editNode { get { return null; } set { } }
