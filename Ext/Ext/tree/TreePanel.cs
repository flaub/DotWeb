...
namespace Ext.tree {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\tree\TreePanel.js</jssource>
	public class TreePanel : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TreePanel(System.String config) { C_(config); }
		...
		/// <returns>Array</returns>
		public virtual void getChecked(System.String attribute) { _(attribute); }

		/// <summary>Retrieve an array of checked nodes, or an array of a specific attribute of checked nodes (e.g. "id")</summary>
		/// <param name="attribute">(optional) Defaults to null (return the actual nodes)</param>
		/// <param name="startNode">(optional) The node to start from, defaults to the root</param>
		/// <returns>Array</returns>
		public virtual void getChecked(System.String attribute, TreeNode startNode) { _(attribute, startNode); }
		...
		/// <returns></returns>
		public virtual void expandPath(System.String path) { _(path); }
		...
		/// <returns></returns>
		public virtual void expandPath(System.String path, System.String attr) { _(path, attr); }
		...
		/// <returns></returns>
		public virtual void expandPath(System.String path, System.String attr, Delegate callback) { _(path, attr, callback); }
		...
		/// <param name="path"></param>
		/// <returns></returns>
		public virtual void selectPath(System.String path) { _(path); }
		...
		/// <param name="attr">(optional) The attribute used in the path (see {@link Ext.data.Node#getPath} for more info)</param>
		/// <returns></returns>
		public virtual void selectPath(System.String path, System.String attr) { _(path, attr); }
		...
		/// <returns></returns>
		public virtual void selectPath(System.String path, System.String attr, Delegate callback) { _(path, attr, callback); }
	...
	[JsAnonymous]
	public class TreePanelConfig : DotWeb.Client.JsAccessible {
		/// <summary> The root node for the tree.</summary>
		public Ext.tree.TreeNode root { get; set; }
		...
		public System.String ddAppendOnly { get; set; }
		...
		public Ext.tree.TreeLoader loader { get; set; }
