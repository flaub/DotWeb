...
namespace Ext {
    ...
    ///     </code></pre>
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\DataView.js</jssource>
    [Native]
    public class DataView : Ext.BoxComponent {
        ...
        /// <returns></returns>
        public DataView(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public DataView(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public DataView(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static DataView prototype { get { return null; } set { } }
        ...
        /// </summary>
        public bool multiSelect { get { return false; } set { } }
        ...
        /// </summary>
        public bool simpleSelect { get { return false; } set { } }
        ...
        public bool trackOver { get { return false; } set { } }
        ...
        public virtual object prepareData() { return null; }
        ...
        /// <returns>Array/Object</returns>
        public virtual object prepareData(System.Array data) { return null; }
        ...
        /// <returns>Array/Object</returns>
        public virtual object prepareData(System.Array data, double recordIndex) { return null; }
        ...
        /// <returns>Array/Object</returns>
        public virtual object prepareData(System.Array data, double recordIndex, Ext.data.Record record) { return null; }
        ...
        /// <param name="data">The raw data object that was used to create the Record.</param>
        /// <returns>Array/Object</returns>
        public virtual object prepareData(object data) { return null; }
        ...
        /// <param name="recordIndex">the index number of the Record being prepared for rendering.</param>
        /// <returns>Array/Object</returns>
        public virtual object prepareData(object data, double recordIndex) { return null; }
        ...
        /// <param name="record">The Record being prepared for rendering.</param>
        /// <returns>Array/Object</returns>
        public virtual object prepareData(object data, double recordIndex, Ext.data.Record record) { return null; }
        ...
        public virtual System.Array collectData() { return null; }
        ...
        public virtual DOMElement findItemFromChild() { return null; }

        /// <summary>Returns the template node the passed child belongs to, or null if it doesn't belong to one.</summary>
        /// <param name="node"></param>
        /// <returns>HTMLElement</returns>
        public virtual DOMElement findItemFromChild(DOMElement node) { return null; }

        /// <summary>Gets the number of selected nodes.</summary>
        /// <returns>Number</returns>
        public virtual double getSelectionCount() { return 0; }
        ...
        /// <returns>Array</returns>
        public virtual System.Array getSelectedIndexes() { return null; }

        /// <summary>Gets an array of the selected records</summary>
        /// <returns>Array</returns>
        public virtual System.Array getSelectedRecords() { return null; }

        /// <summary>Gets an array of the records from an array of nodes</summary>
        /// <returns>Array</returns>
        public virtual System.Array getRecords() { return null; }

        /// <summary>Gets an array of the records from an array of nodes</summary>
        /// <param name="nodes">The nodes to evaluate</param>
        /// <returns>Array</returns>
        public virtual System.Array getRecords(System.Array nodes) { return null; }

        /// <summary>Gets a record from a node</summary>
        /// <returns>Record</returns>
        public virtual Ext.data.Record getRecord() { return null; }

        /// <summary>Gets a record from a node</summary>
        /// <param name="node">The node to evaluate</param>
        /// <returns>Record</returns>
        public virtual Ext.data.Record getRecord(DOMElement node) { return null; }
        ...
        /// <returns></returns>
        public virtual void clearSelections(bool suppressEvent) { return ; }
        ...
        /// <returns>Boolean</returns>
        public virtual bool isSelected(DOMElement node) { return false; }

        /// <summary>Returns true if the passed node is selected, else false.</summary>
        /// <param name="node">The node or node index to check</param>
        /// <returns>Boolean</returns>
        public virtual bool isSelected(double node) { return false; }

        /// <summary>Deselects a node.</summary>
        /// <returns></returns>
        public virtual void deselect() { return ; }

        /// <summary>Deselects a node.</summary>
        /// <param name="node">The node to deselect</param>
        /// <returns></returns>
        public virtual void deselect(DOMElement node) { return ; }

        /// <summary>Deselects a node.</summary>
        /// <param name="node">The node to deselect</param>
        /// <returns></returns>
        public virtual void deselect(double node) { return ; }
        ...
        /// <returns></returns>
        public virtual void select(System.Array nodeInfo) { return ; }
        ...
        /// <returns></returns>
        public virtual void select(System.Array nodeInfo, bool keepExisting) { return ; }
        ...
        /// <returns></returns>
        public virtual void select(System.Array nodeInfo, bool keepExisting, bool suppressEvent) { return ; }
        ...
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node,</param>
        /// <returns></returns>
        public virtual void select(DOMElement nodeInfo) { return ; }
        ...
        /// <param name="keepExisting">(optional) true to keep existing selections</param>
        /// <returns></returns>
        public virtual void select(DOMElement nodeInfo, bool keepExisting) { return ; }
        ...
        /// <param name="suppressEvent">(optional) true to skip firing of the selectionchange vent</param>
        /// <returns></returns>
        public virtual void select(DOMElement nodeInfo, bool keepExisting, bool suppressEvent) { return ; }
        ...
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node,</param>
        /// <returns></returns>
        public virtual void select(System.String nodeInfo) { return ; }
        ...
        /// <param name="keepExisting">(optional) true to keep existing selections</param>
        /// <returns></returns>
        public virtual void select(System.String nodeInfo, bool keepExisting) { return ; }
        ...
        /// <param name="suppressEvent">(optional) true to skip firing of the selectionchange vent</param>
        /// <returns></returns>
        public virtual void select(System.String nodeInfo, bool keepExisting, bool suppressEvent) { return ; }
        ...
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node,</param>
        /// <returns></returns>
        public virtual void select(double nodeInfo) { return ; }
        ...
        /// <param name="keepExisting">(optional) true to keep existing selections</param>
        /// <returns></returns>
        public virtual void select(double nodeInfo, bool keepExisting) { return ; }
        ...
        /// <param name="suppressEvent">(optional) true to skip firing of the selectionchange vent</param>
        /// <returns></returns>
        public virtual void select(double nodeInfo, bool keepExisting, bool suppressEvent) { return ; }
        ...
        /// <returns></returns>
        public virtual void selectRange(double start) { return ; }

        /// <summary>Selects a range of nodes. All nodes between start and end are selected.</summary>
        /// <param name="start">The index of the first node in the range</param>
        /// <param name="end">The index of the last node in the range</param>
        /// <returns></returns>
        public virtual void selectRange(double start, double end) { return ; }
        ...
        /// <returns></returns>
        public virtual void selectRange(double start, double end, bool keepExisting) { return ; }

        /// <summary>Gets a template node.</summary>
        /// <returns>HTMLElement</returns>
        public virtual DOMElement getNode() { return null; }

        /// <summary>Gets a template node.</summary>
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>HTMLElement</returns>
        public virtual DOMElement getNode(DOMElement nodeInfo) { return null; }

        /// <summary>Gets a template node.</summary>
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>HTMLElement</returns>
        public virtual DOMElement getNode(System.String nodeInfo) { return null; }

        /// <summary>Gets a template node.</summary>
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>HTMLElement</returns>
        public virtual DOMElement getNode(double nodeInfo) { return null; }

        /// <summary>Gets a range nodes.</summary>
        /// <returns>Array</returns>
        public virtual System.Array getNodes() { return null; }

        /// <summary>Gets a range nodes.</summary>
        /// <param name="start">(optional) The index of the first node in the range</param>
        /// <returns>Array</returns>
        public virtual System.Array getNodes(double start) { return null; }

        /// <summary>Gets a range nodes.</summary>
        /// <param name="start">(optional) The index of the first node in the range</param>
        /// <param name="end">(optional) The index of the last node in the range</param>
        /// <returns>Array</returns>
        public virtual System.Array getNodes(double start, double end) { return null; }
        ...
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>Number</returns>
        public virtual double indexOf(DOMElement nodeInfo) { return 0; }

        /// <summary>Finds the index of the passed node.</summary>
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>Number</returns>
        public virtual double indexOf(System.String nodeInfo) { return 0; }

        /// <summary>Finds the index of the passed node.</summary>
        /// <param name="nodeInfo">An HTMLElement template node, index of a template node or the id of a template node</param>
        /// <returns>Number</returns>
        public virtual double indexOf(double nodeInfo) { return 0; }
