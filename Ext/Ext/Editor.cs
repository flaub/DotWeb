...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\Editor.js</jssource>
	public class Editor : Ext.Component {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Editor(System.String config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		...
		public System.String alignment { get { return _<System.String>(); } set { _(value); } }
		...
		/// <returns></returns>
		public virtual void startEdit(object el, System.String value) { _(el, value); }
	...
	[JsAnonymous]
	public class EditorConfig : DotWeb.Client.JsAccessible {
		...
		/// <summary>  The position to align to (see {@link Ext.Element#alignTo} for more details, defaults to "c-c?").</summary>
		public System.String alignment { get; set; }
