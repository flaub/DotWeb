...
namespace Ext {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\Editor.js</jssource>
    [Native]
    public class Editor : Ext.Component {
        ...
        /// <returns></returns>
        public Editor(Ext.form.Field field) {}
        /// <summary>Create a new Editor</summary>
        /// <param name="field">The Field object (or descendant)</param>
        /// <param name="config">The config object</param>
        /// <returns></returns>
        public Editor(Ext.form.Field field, object config) {}
        /// <summary>
        ...
        /// <returns></returns>
        public Editor(Ext.Element config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public Editor(System.String config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public Editor(object config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static Editor prototype { get { return null; } set { } }
        ...
        /// </summary>
        public object autoSize { get { return null; } set { } }

        /// <summary>
        ///     True to automatically revert the field value and cancel the edit when the user completes an edit and the field
        ///     validation fails (defaults to true)
        /// </summary>
        public bool revertInvalid { get { return false; } set { } }
        ...
        public System.String alignment { get { return null; } set { } }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void startEdit() { return ; }
        ...
        /// <returns></returns>
        public virtual void startEdit(object el) { return ; }
        ...
        /// <returns></returns>
        public virtual void startEdit(object el, System.String value) { return ; }

        /// <summary>Sets the height and width of this editor.</summary>
        /// <returns></returns>
        public virtual void setSize() { return ; }

        /// <summary>Sets the height and width of this editor.</summary>
        /// <param name="width">The new width</param>
        /// <returns></returns>
        public virtual void setSize(double width) { return ; }

        /// <summary>Sets the height and width of this editor.</summary>
        /// <param name="width">The new width</param>
        /// <param name="height">The new height</param>
        /// <returns></returns>
        public virtual void setSize(double width, double height) { return ; }
        ...
        /// <returns></returns>
        public virtual void cancelEdit(bool remainVisible) { return ; }
        ...
        /// <returns></returns>
        public virtual void setValue(object value) { return ; }
