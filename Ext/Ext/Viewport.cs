...
namespace Ext {
    ...
    ///     </code></pre>
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\Viewport.js</jssource>
    [Native]
    public class Viewport : Ext.Container {
        ...
        /// <returns></returns>
        public Viewport(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public Viewport(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static Viewport prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.Container superclass { get { return null; } set { } }


        /// <summary>@cfg {Boolean} monitorResize @hide</summary>
        /// <returns></returns>
        public virtual void initComponent() { return ; }
