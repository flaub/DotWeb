...
namespace Ext.data {
    ...
    public class Connection : Ext.util.Observable {
        ...
        public static Connection prototype { get { return null; } set { } }
        ...
        public virtual double request() { return 0; }
        ...
        /// <returns>Number</returns>
        public virtual double request(object options) { return 0; }
        ...
        /// <returns>Boolean</returns>
        public virtual bool isLoading(double transactionId) { return false; }
        ...
        /// <param name="transactionId">(Optional) defaults to the last transaction</param>
        /// <returns></returns>
        public virtual void abort(double transactionId) { return ; }
