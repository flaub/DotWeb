...
namespace Ext.data {
    ...
    ///     </code></pre>
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\data\ScriptTagProxy.js</jssource>
    [Native]
    public class ScriptTagProxy : Ext.data.DataProxy {
        ...
        /// <returns></returns>
        public ScriptTagProxy(object config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static ScriptTagProxy prototype { get { return null; } set { } }
