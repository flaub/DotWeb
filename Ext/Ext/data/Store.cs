...
namespace Ext.data {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\data\Store.js</jssource>
    [Native]
    public class Store : Ext.util.Observable {
        ...
        public static Store prototype { get { return null; } set { } }
        ...
        /// </summary>
        public object lastOptions { get { return null; } set { } }
        ...
        /// <returns></returns>
        public virtual void add(Ext.data.Record[] records) { return ; }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void addSorted() { return ; }
        ...
        /// <returns></returns>
        public virtual void addSorted(Ext.data.Record record) { return ; }
        ...
        /// <returns>Number</returns>
        public virtual double indexOf(Ext.data.Record record) { return 0; }

        /// <summary>Get the index within the cache of the Record with the passed id.</summary>
        /// <returns>Number</returns>
        public virtual double indexOfId() { return 0; }

        /// <summary>Get the index within the cache of the Record with the passed id.</summary>
        /// <param name="id">The id of the Record to find.</param>
        /// <returns>Number</returns>
        public virtual double indexOfId(System.String id) { return 0; }

        /// <summary>Get the Record with the specified id.</summary>
        /// <returns>Ext.data.Record</returns>
        public virtual Ext.data.Record getById() { return null; }

        /// <summary>Get the Record with the specified id.</summary>
        /// <param name="id">The id of the Record to find.</param>
        /// <returns>Ext.data.Record</returns>
        public virtual Ext.data.Record getById(System.String id) { return null; }

        /// <summary>Get the Record at the specified index.</summary>
        /// <returns>Ext.data.Record</returns>
        public virtual Ext.data.Record getAt() { return null; }

        /// <summary>Get the Record at the specified index.</summary>
        /// <param name="index">The index of the Record to find.</param>
        /// <returns>Ext.data.Record</returns>
        public virtual Ext.data.Record getAt(double index) { return null; }

        /// <summary>Returns a range of Records between specified indices.</summary>
        /// <returns>Ext.data.Record[]</returns>
        public virtual Ext.data.Record[] getRange() { return null; }

        /// <summary>Returns a range of Records between specified indices.</summary>
        /// <param name="startIndex">(optional) The starting index (defaults to 0)</param>
        /// <returns>Ext.data.Record[]</returns>
        public virtual Ext.data.Record[] getRange(double startIndex) { return null; }

        /// <summary>Returns a range of Records between specified indices.</summary>
        /// <param name="startIndex">(optional) The starting index (defaults to 0)</param>
        /// <param name="endIndex">(optional) The ending index (defaults to the last Record in the Store)</param>
        /// <returns>Ext.data.Record[]</returns>
        public virtual Ext.data.Record[] getRange(double startIndex, double endIndex) { return null; }
        ...
        /// <returns>Boolean</returns>
        public virtual bool load(object options) { return false; }
        ...
        /// <returns></returns>
        public virtual void reload(object options) { return ; }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void loadData() { return ; }
        ...
        /// <returns></returns>
        public virtual void loadData(object data) { return ; }
        ...
        /// <returns></returns>
        public virtual void loadData(object data, bool append) { return ; }
        ...
        /// </summary>
        /// <returns>Number</returns>
        public virtual double getTotalCount() { return 0; }
        ...
        /// <param name="fieldName">The name of the field to sort by.</param>
        /// <returns></returns>
        public virtual void sort(System.String fieldName) { return ; }
        ...
        /// <param name="dir">(optional) The sort order, "ASC" or "DESC" (case-sensitive, defaults to "ASC")</param>
        /// <returns></returns>
        public virtual void sort(System.String fieldName, System.String dir) { return ; }
        ...
        /// </summary>
        /// <returns>Ext.data.Record[]</returns>
        public virtual Ext.data.Record[] getModifiedRecords() { return null; }

        /// <summary>Sums the value of <i>property</i> for each record between start and end and returns the result.</summary>
        /// <returns>Number</returns>
        public virtual double sum() { return 0; }

        /// <summary>Sums the value of <i>property</i> for each record between start and end and returns the result.</summary>
        /// <param name="property">A field on your records</param>
        /// <returns>Number</returns>
        public virtual double sum(System.String property) { return 0; }

        /// <summary>Sums the value of <i>property</i> for each record between start and end and returns the result.</summary>
        /// <param name="property">A field on your records</param>
        /// <param name="start">The record index to start at (defaults to 0)</param>
        /// <returns>Number</returns>
        public virtual double sum(System.String property, double start) { return 0; }
        ...
        /// <returns>Number</returns>
        public virtual double sum(System.String property, double start, double end) { return 0; }
        ...
        /// <returns></returns>
        public virtual void filter(System.String field) { return ; }
        ...
        /// <returns></returns>
        public virtual void filter(System.String field, System.String value) { return ; }
        ...
        /// <returns></returns>
        public virtual void filter(System.String field, System.String value, bool anyMatch) { return ; }
        ...
        /// <returns></returns>
        public virtual void filter(System.String field, System.String value, bool anyMatch, bool caseSensitive) { return ; }
        ...
        /// <param name="value">Either a string that the field</param>
        /// <returns></returns>
        public virtual void filter(System.String field, object value) { return ; }
        ...
        /// <param name="anyMatch">(optional) True to match any part not just the beginning</param>
        /// <returns></returns>
        public virtual void filter(System.String field, object value, bool anyMatch) { return ; }
        ...
        /// <param name="caseSensitive">(optional) True for case sensitive comparison</param>
        /// <returns></returns>
        public virtual void filter(System.String field, object value, bool anyMatch, bool caseSensitive) { return ; }
        ...
        public virtual Ext.util.MixedCollection query() { return null; }
        ...
        /// <param name="field">A field on your records</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field) { return null; }
        ...
        /// <param name="value">Either a string that the field</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, System.String value) { return null; }
        ...
        /// <param name="anyMatch">(optional) True to match any part not just the beginning</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, System.String value, bool anyMatch) { return null; }
        ...
        /// <param name="caseSensitive">(optional) True for case sensitive comparison</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, System.String value, bool anyMatch, bool caseSensitive) { return null; }
        ...
        /// <param name="value">Either a string that the field</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, object value) { return null; }
        ...
        /// <param name="anyMatch">(optional) True to match any part not just the beginning</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, object value, bool anyMatch) { return null; }
        ...
        /// <param name="caseSensitive">(optional) True for case sensitive comparison</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection query(System.String field, object value, bool anyMatch, bool caseSensitive) { return null; }
        ...
        /// </summary>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection find() { return null; }
        ...
        /// <param name="fn">The function to be called. It will be passed the following parameters:<ul></param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection find(Delegate fn) { return null; }
        ...
        /// <param name="scope">(optional) The scope of the function (defaults to this)</param>
        /// <returns>MixedCollection</returns>
        public virtual Ext.util.MixedCollection find(Delegate fn, object scope) { return null; }
        ...
        /// </summary>
        /// <returns>Number</returns>
        public virtual double findBy() { return 0; }
        ...
        /// <param name="fn">The function to be called. It will be passed the following parameters:<ul></param>
        /// <returns>Number</returns>
        public virtual double findBy(Delegate fn) { return 0; }
        ...
        /// <param name="scope">(optional) The scope of the function (defaults to this)</param>
        /// <returns>Number</returns>
        public virtual double findBy(Delegate fn, object scope) { return 0; }
        ...
        /// <returns>Number</returns>
        public virtual double findBy(Delegate fn, object scope, double startIndex) { return 0; }

        /// <summary>Collects unique values for a particular dataIndex from this store.</summary>
        /// <returns>Array</returns>
        public virtual System.Array clearFilter() { return null; }

        /// <summary>Collects unique values for a particular dataIndex from this store.</summary>
        /// <param name="dataIndex">The property to collect</param>
        /// <returns>Array</returns>
        public virtual System.Array clearFilter(System.String dataIndex) { return null; }

        /// <summary>Collects unique values for a particular dataIndex from this store.</summary>
        /// <param name="dataIndex">The property to collect</param>
        /// <param name="allowNull">(optional) Pass true to allow null, undefined or empty string values</param>
        /// <returns>Array</returns>
        public virtual System.Array clearFilter(System.String dataIndex, bool allowNull) { return null; }
        ...
        /// <returns>Array</returns>
        public virtual System.Array clearFilter(System.String dataIndex, bool allowNull, bool bypassFilter) { return null; }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void commitChanges() { return ; }

        /// <summary>Cancel outstanding changes on all changed records.</summary>
        /// <returns></returns>
        public virtual void rejectChanges() { return ; }
