...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\tips\ToolTip.js</jssource>
	public class ToolTip : Ext.Tip {
		...
		/// <returns></returns>
		public ToolTip(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public ToolTip(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public ToolTip(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static ToolTip prototype { get { return S_<ToolTip>(); } set { S_(value); } }

		/// <summary>The reference to the constructor function</summary>
		public static Delegate constructor { get { return S_<Delegate>(); } set { S_(value); } }

		/// <summary>The reference to the class that this class inherits from</summary>
		public static Ext.Tip superclass { get { return S_<Ext.Tip>(); } set { S_(value); } }
	...
	[JsAnonymous]
	public class ToolTipConfig : DotWeb.Client.JsAccessible {
		/// <summary> The target HTMLElement, Ext.Element or id to associate with this tooltip.</summary>
