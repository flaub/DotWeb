...
namespace Ext {
    ...
    ///     </code></pre>
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\CycleButton.js</jssource>
    [Native]
    public class CycleButton : Ext.SplitButton {
        ...
        /// <returns></returns>
        public CycleButton(object config) {}
        /// <summary>
        ...
        /// <returns></returns>
        public CycleButton(Ext.Element config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public CycleButton(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static CycleButton prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.SplitButton superclass { get { return null; } set { } }
        ...
        public System.String prependText { get { return null; } set { } }
        ...
        /// </summary>
        public Delegate changeHandler { get { return null; } set { } }
        ...
        /// </summary>
        public System.String forceIcon { get { return null; } set { } }


        /// <summary>Sets the button's active menu item.</summary>
        /// <returns></returns>
        public virtual void setActiveItem() { return ; }

        /// <summary>Sets the button's active menu item.</summary>
        /// <param name="item">The item to activate</param>
        /// <returns></returns>
        public virtual void setActiveItem(Ext.menu.CheckItem item) { return ; }

        /// <summary>Sets the button's active menu item.</summary>
        /// <param name="item">The item to activate</param>
        /// <param name="suppressEvent">True to prevent the button's change event from firing (defaults to false)</param>
        /// <returns></returns>
        public virtual void setActiveItem(Ext.menu.CheckItem item, bool suppressEvent) { return ; }

        /// <summary>Gets the currently active menu item.</summary>
        /// <returns>Ext.menu.CheckItem</returns>
        public virtual Ext.menu.CheckItem getActiveItem() { return null; }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void toggleSelected() { return ; }
