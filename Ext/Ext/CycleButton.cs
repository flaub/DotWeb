...
namespace Ext {
	...
	///     </code></pre>
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\CycleButton.js</jssource>
	public class CycleButton : Ext.SplitButton {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public CycleButton(System.String config) { C_(config); }
		...
		public System.String prependText { get { return _<System.String>(); } set { _(value); } }
		...
		/// </summary>
		public System.String forceIcon { get { return _<System.String>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class CycleButtonConfig : DotWeb.Client.JsAccessible {
		...
		public System.Array items { get; set; }
		...
		public System.String prependText { get; set; }
		...
		public Delegate changeHandler { get; set; }
