...
namespace Ext.util {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\util\ClickRepeater.js</jssource>
    [Native]
    public class ClickRepeater : Ext.util.Observable {
        ...
        /// <returns></returns>
        public ClickRepeater(object el) {}
        /// <summary></summary>
        /// <param name="el">The element to listen on</param>
        ...
        public static ClickRepeater prototype { get { return null; } set { } }
