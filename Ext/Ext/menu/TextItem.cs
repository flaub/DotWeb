...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\TextItem.js</jssource>
	public class TextItem : Ext.menu.BaseItem {
		...
		/// <returns></returns>
		public TextItem(object config) { C_(config); }
		/// <summary>
		///     Creates a new TextItem
		///     is applied as a config object (and should contain a <tt>text</tt> property).
		/// </summary>
		/// <param name="config">If config is a string, it is used as the text to display, otherwise it</param>
		/// <returns></returns>
		public TextItem(System.String config) { C_(config); }
		/// <summary>
		...
		/// <returns></returns>
		public TextItem(Ext.Element config) { C_(config); }
	...
	[JsAnonymous]
	public class TextItemConfig : DotWeb.Client.JsAccessible {
		/// <summary> The text to display for this item (defaults to '')</summary>
