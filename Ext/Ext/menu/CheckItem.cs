...
namespace Ext.menu {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\menu\CheckItem.js</jssource>
    [Native]
    public class CheckItem : Ext.menu.Item {
        ...
        /// <returns></returns>
        public CheckItem(object config) {}
        /// <summary>
        ...
        /// <returns></returns>
        public CheckItem(Ext.Element config) {}
        /// <summary>
        ///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
        ///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
        /// </summary>
        /// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
        /// <returns></returns>
        public CheckItem(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static CheckItem prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.menu.Item superclass { get { return null; } set { } }

        /// <summary>
        ///     All check items with the same group name will automatically be grouped into a single-select
        ///     radio button group (defaults to '')
        /// </summary>
        public System.String group { get { return null; } set { } }
        ...
        public System.String groupClass { get { return null; } set { } }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual void checkHandler() { return ; }
        ...
        /// <returns></returns>
        public virtual void checkHandler(Ext.menu.CheckItem objthis) { return ; }
        ...
        /// <returns></returns>
        public virtual void checkHandler(Ext.menu.CheckItem objthis, bool chckd) { return ; }

        /// <summary>Set the checked state of this item</summary>
        /// <returns></returns>
        public virtual void setChecked() { return ; }

        /// <summary>Set the checked state of this item</summary>
        /// <param name="chckd">The new checked value</param>
        /// <returns></returns>
        public virtual void setChecked(bool chckd) { return ; }

        /// <summary>Set the checked state of this item</summary>
        /// <param name="chckd">The new checked value</param>
        /// <param name="suppressEvent">(optional) True to prevent the checkchange event from firing (defaults to false)</param>
        /// <returns></returns>
        public virtual void setChecked(bool chckd, bool suppressEvent) { return ; }
