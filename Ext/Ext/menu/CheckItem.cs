...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\CheckItem.js</jssource>
	public class CheckItem : Ext.menu.Item {
		...
		/// <returns></returns>
		public CheckItem(object config) { C_(config); }
		/// <summary>
		...
		/// <returns></returns>
		public CheckItem(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public CheckItem(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static CheckItem prototype { get { return S_<CheckItem>(); } set { S_(value); } }

		/// <summary>The reference to the constructor function</summary>
		public static Delegate constructor { get { return S_<Delegate>(); } set { S_(value); } }

		/// <summary>The reference to the class that this class inherits from</summary>
		public static Ext.menu.Item superclass { get { return S_<Ext.menu.Item>(); } set { S_(value); } }

		/// <summary>
		///     All check items with the same group name will automatically be grouped into a single-select
		///     radio button group (defaults to '')
		/// </summary>
		public System.String group { get { return _<System.String>(); } set { _(value); } }

		/// <summary>The default CSS class to use for check items (defaults to "x-menu-item x-menu-check-item")</summary>
		public System.String itemCls { get { return _<System.String>(); } set { _(value); } }

		/// <summary>The default CSS class to use for radio group check items (defaults to "x-menu-group-item")</summary>
		public System.String groupClass { get { return _<System.String>(); } set { _(value); } }
		...
		/// </summary>
		/// <returns></returns>
		public virtual void checkHandler() { _(); }
		...
		/// <returns></returns>
		public virtual void checkHandler(Ext.menu.CheckItem objthis) { _(objthis); }
		...
		/// <returns></returns>
		public virtual void checkHandler(Ext.menu.CheckItem objthis, bool chckd) { _(objthis, chckd); }

		/// <summary>Set the checked state of this item</summary>
		/// <returns></returns>
		public virtual void setChecked() { _(); }

		/// <summary>Set the checked state of this item</summary>
		/// <param name="chckd">The new checked value</param>
		/// <returns></returns>
		public virtual void setChecked(bool chckd) { _(chckd); }

		/// <summary>Set the checked state of this item</summary>
		/// <param name="chckd">The new checked value</param>
		/// <param name="suppressEvent">(optional) True to prevent the checkchange event from firing (defaults to false)</param>
		/// <returns></returns>
		public virtual void setChecked(bool chckd, bool suppressEvent) { _(chckd, suppressEvent); }
	...
	[JsAnonymous]
	public class CheckItemConfig : DotWeb.Client.JsAccessible {
		...
		/// <summary> The default CSS class to use for radio group check items (defaults to "x-menu-group-item")</summary>
		public System.String groupClass { get; set; }
