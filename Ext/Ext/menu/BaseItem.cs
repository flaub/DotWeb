...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\BaseItem.js</jssource>
	public class BaseItem : Ext.Component {
		...
		/// <returns></returns>
		public BaseItem(object config) { C_(config); }
		/// <summary>
		...
		/// <returns></returns>
		public BaseItem(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public BaseItem(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static BaseItem prototype { get { return S_<BaseItem>(); } set { S_(value); } }
		...
		public System.String activeClass { get { return _<System.String>(); } set { _(value); } }
		...
		public Ext.menu.Menu parentMenu { get { return _<Ext.menu.Menu>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class BaseItemConfig : DotWeb.Client.JsAccessible {
		/// <summary>  A function that will handle the click event of this menu item (defaults to undefined)</summary>
