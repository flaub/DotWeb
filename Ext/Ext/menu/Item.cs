...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\Item.js</jssource>
	public class Item : Ext.menu.BaseItem {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Item(System.String config) { C_(config); }
		...
		public System.String icon { get { return _<System.String>(); } set { _(value); } }
		...
		public System.String href { get { return _<System.String>(); } set { _(value); } }

		/// <summary>The target attribute to use for the underlying anchor link (defaults to '').</summary>
		public System.String hrefTarget { get { return _<System.String>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class ItemConfig : DotWeb.Client.JsAccessible {
		/// <summary> Either an instance of {@link Ext.menu.Menu} or the config object for an {@link Ext.menu.Menu} which acts as the submenu when this item is activated.</summary>
