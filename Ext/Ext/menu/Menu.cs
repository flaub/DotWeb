...
namespace Ext.menu {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\menu\Menu.js</jssource>
    [Native]
    public class Menu : Ext.util.Observable {
        ...
        public static Menu prototype { get { return null; } set { } }
        ...
        public Ext.util.MixedCollection items { get { return null; } set { } }
        ...
        /// <returns></returns>
        public virtual void show(object element) { return ; }
        ...
        /// <returns></returns>
        public virtual void show(object element, System.String position) { return ; }
        ...
        /// <returns></returns>
        public virtual void show(object element, System.String position, Ext.menu.Menu parentMenu) { return ; }

        /// <summary>Displays this menu at a specific xy position</summary>
        /// <returns></returns>
        public virtual void showAt() { return ; }
        ...
        /// <returns></returns>
        public virtual void showAt(System.Array xyPosition) { return ; }

        /// <summary>Displays this menu at a specific xy position</summary>
        /// <param name="xyPosition">Contains X & Y [x, y] values for the position at which to show the menu (coordinates are page-based)</param>
        /// <param name="parentMenu">(optional) This menu's parent menu, if applicable (defaults to undefined)</param>
        /// <returns></returns>
        public virtual void showAt(System.Array xyPosition, Ext.menu.Menu parentMenu) { return ; }
        ...
        /// <returns></returns>
        public virtual void hide(bool deep) { return ; }
        ...
        public virtual Ext.menu.Item add() { return null; }
        ...
        /// <returns>Ext.menu.Item</returns>
        public virtual Ext.menu.Item add(object args) { return null; }
        ...
        /// <returns></returns>
        public virtual void remove(Ext.menu.Item item) { return ; }
