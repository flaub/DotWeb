...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\DateItem.js</jssource>
	public class DateItem : Ext.menu.Adapter {
		...
		/// <returns></returns>
		public DateItem(object config) { C_(config); }
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <returns></returns>
		public DateItem(Ext.Component component) { C_(component); }
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public DateItem(Ext.Component component, object config) { C_(component, config); }
		/// <summary>
		...
		/// <returns></returns>
		public DateItem(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public DateItem(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static DateItem prototype { get { return S_<DateItem>(); } set { S_(value); } }
		...
		public Ext.DatePicker picker { get { return _<Ext.DatePicker>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class DateItemConfig : DotWeb.Client.JsAccessible {
