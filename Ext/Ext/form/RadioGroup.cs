...
namespace Ext.form {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\form\RadioGroup.js</jssource>
    [Native]
    public class RadioGroup : Ext.form.CheckboxGroup {
        ...
        /// <returns></returns>
        public RadioGroup(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public RadioGroup(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public RadioGroup(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static RadioGroup prototype { get { return null; } set { } }

        /// <summary>The reference to the constructor function</summary>
        public static Delegate constructor { get { return null; } set { } }

        /// <summary>The reference to the class that this class inherits from</summary>
        public static Ext.form.CheckboxGroup superclass { get { return null; } set { } }
