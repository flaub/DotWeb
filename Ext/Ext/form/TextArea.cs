...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\TextArea.js</jssource>
	public class TextArea : Ext.form.TextField {
		...
		/// <returns></returns>
		public TextArea(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TextArea(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TextArea(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static TextArea prototype { get { return S_<TextArea>(); } set { S_(value); } }
		...
		public bool preventScrollbars { get { return _<bool>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class TextAreaConfig : DotWeb.Client.JsAccessible {
		/// <summary> The minimum height to allow when grow = true (defaults to 60)</summary>
