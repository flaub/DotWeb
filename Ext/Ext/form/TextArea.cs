...
namespace Ext.form {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\form\TextArea.js</jssource>
    [Native]
    public class TextArea : Ext.form.TextField {
        ...
        /// <returns></returns>
        public TextArea(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public TextArea(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public TextArea(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static TextArea prototype { get { return null; } set { } }
        ...
        public bool preventScrollbars { get { return false; } set { } }
