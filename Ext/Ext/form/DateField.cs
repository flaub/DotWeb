...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\DateField.js</jssource>
	public class DateField : Ext.form.TriggerField {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public DateField(System.String config) { C_(config); }
		...
		/// <returns></returns>
		public virtual void setValue(System.String date) { _(date); }
	...
	[JsAnonymous]
	public class DateFieldConfig : DotWeb.Client.JsAccessible {
