...
namespace Ext.form {
	...
	///     });</code></pre><br>
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\Form.js</jssource>
	public class FormPanel : Ext.Panel {
		...
		/// <returns></returns>
		public FormPanel(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FormPanel(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FormPanel(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static FormPanel prototype { get { return S_<FormPanel>(); } set { S_(value); } }
		...
		public System.String formId { get { return _<System.String>(); } set { _(value); } }
		...
		public double labelWidth { get { return _<double>(); } set { _(value); } }
		...
		public System.String buttonAlign { get { return _<System.String>(); } set { _(value); } }
		...
		/// </summary>
		public System.String labelAlign { get { return _<System.String>(); } set { _(value); } }
		...
		/// </summary>
		public bool monitorValid { get { return _<bool>(); } set { _(value); } }

		/// <summary>The milliseconds to poll valid state, ignored if monitorValid is not true (defaults to 200)</summary>
		public double monitorPoll { get { return _<double>(); } set { _(value); } }

		/// <summary>@cfg {String} layout @hide</summary>
		public object layout { get { return _<object>(); } set { _(value); } }
		...
		/// </summary>
		/// <returns></returns>
		public virtual void startMonitoring() { _(); }

		/// <summary>Stops monitoring of the valid state of this form</summary>
		/// <returns></returns>
		public virtual void stopMonitoring() { _(); }
	...
	[JsAnonymous]
	public class FormPanelConfig : DotWeb.Client.JsAccessible {
		/// <summary> (optional) The id of the FORM tag (defaults to an auto-generated id).</summary>
		public System.String formId { get; set; }
