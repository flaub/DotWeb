...
namespace Ext.form {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\form\TriggerField.js</jssource>
    [Native]
    public class TriggerField : Ext.form.TextField {
        ...
        /// <returns></returns>
        public TriggerField(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public TriggerField(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public TriggerField(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static TriggerField prototype { get { return null; } set { } }
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        public virtual void onTriggerClick(EventObject e) { return ; }
