...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\Checkbox.js</jssource>
	public class Checkbox : Ext.form.Field {
		...
		/// <returns></returns>
		public Checkbox(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Checkbox(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Checkbox(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static Checkbox prototype { get { return S_<Checkbox>(); } set { S_(value); } }
		...
		public System.String checkedCls { get { return _<System.String>(); } set { _(value); } }
		...
		public System.String focusCls { get { return _<System.String>(); } set { _(value); } }
		...
		public System.String mouseDownCls { get { return _<System.String>(); } set { _(value); } }
		...
		public System.String boxLabel { get { return _<System.String>(); } set { _(value); } }
		...
		public System.String inputValue { get { return _<System.String>(); } set { _(value); } }
		...
		/// <returns></returns>
		public virtual void setValue(bool chckd) { _(chckd); }

		/// <summary>Sets the checked state of the checkbox.</summary>
		/// <param name="chckd">True, 'true', '1', or 'on' to check the checkbox, any other value will uncheck it.</param>
		/// <returns></returns>
		public virtual void setValue(System.String chckd) { _(chckd); }
	...
	[JsAnonymous]
	public class CheckboxConfig : DotWeb.Client.JsAccessible {
		/// <summary> The CSS class to use when the control is checked (defaults to 'x-form-check-checked'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element.</summary>
