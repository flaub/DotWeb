...
namespace Ext.form {
    ...
    /// </summary>
    /// <jssource>C:\home\src\external\ext-2.2\source\widgets\form\Hidden.js</jssource>
    [Native]
    public class Hidden : Ext.form.Field {
        ...
        /// <returns></returns>
        public Hidden(object config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public Hidden(Ext.Element config) {}
        /// <summary></summary>
        /// <param name="config">The configuration options.</param>
        /// <returns></returns>
        public Hidden(System.String config) {}

        /// <summary>The reference to the prototype the every object of this type is constructed with</summary>
        public static Hidden prototype { get { return null; } set { } }
