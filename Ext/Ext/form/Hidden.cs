...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\Hidden.js</jssource>
	public class Hidden : Ext.form.Field {
		...
		/// <returns></returns>
		public Hidden(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Hidden(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Hidden(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static Hidden prototype { get { return S_<Hidden>(); } set { S_(value); } }
	...
	[JsAnonymous]
	public class HiddenConfig : DotWeb.Client.JsAccessible {
