...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\FieldSet.js</jssource>
	public class FieldSet : Ext.Panel {
		...
		/// <returns></returns>
		public FieldSet(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FieldSet(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FieldSet(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static FieldSet prototype { get { return S_<FieldSet>(); } set { S_(value); } }
		...
		/// </summary>
		public object checkboxToggle { get { return _<object>(); } set { _(value); } }
		...
		public System.String checkboxName { get { return _<System.String>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class FieldSetConfig : DotWeb.Client.JsAccessible {
		...
		/// <summary> The name to assign to the fieldset's checkbox if {@link #checkboxToggle} = true (defaults to '[checkbox id]-checkbox').</summary>
		public System.String checkboxName { get; set; }
