...
namespace DotWeb.Decompiler.Core
{
	public class MethodBodyReader
	{
		...
		public MethodBodyReader(MethodDefinition method) {
			this.Method = method;
			this.MethodBody = method.Body;
			this.Instructions = this.MethodBody.Instructions.Cast<Instruction>();
			method.Body.Instructions.Cast<Instruction>();
...
//        private object ResolveField(int metadataToken, MethodReference method) {
//            Module module = method.Module;
...
//        private object ResolveMember(int metadataToken, MethodReference method) {
//            Module module = method.Module;
...
//        private object ResolveToken(int metadataToken, MethodReference method) {
//            Module module = method.Module;
