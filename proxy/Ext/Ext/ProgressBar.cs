...
namespace Ext {
	...
	public class ProgressBar : Ext.BoxComponent {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public ProgressBar(string config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		...
		/// <returns>Ext.ProgressBar</returns>
		public virtual void updateProgress(double value, string text) { _(value, text); }
		...
		/// <param name="text">(optional) The string to display in the progress text element (defaults to '')</param>
		/// <returns>Ext.ProgressBar</returns>
		public virtual void updateText(string text) { _(text); }
	...
	[JsAnonymous]
	public class ProgressBarConfig : DotWeb.Client.JsDynamicBase {
