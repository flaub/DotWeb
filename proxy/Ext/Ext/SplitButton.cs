...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\SplitButton.js</jssource>
	public class SplitButton : Ext.Button {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public SplitButton(System.String config) { C_(config); }
	...
	[JsAnonymous]
	public class SplitButtonConfig : DotWeb.Client.JsAccessible {
