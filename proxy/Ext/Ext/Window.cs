...
namespace Ext {
	...
	public class WindowClass : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public WindowClass(string config) { C_(config); }
		...
		public string resizeHandles { get { return _<string>(); } set { _(value); } }
		...
		/// </summary>
		public string closeAction { get { return _<string>(); } set { _(value); } }
		...
		/// <returns></returns>
		public virtual void setAnimateTarget(string el) { _(el); }
		...
		/// <returns></returns>
		public virtual void show(string animateTarget) { _(animateTarget); }
		...
		/// <returns></returns>
		public virtual void show(string animateTarget, Delegate callback) { _(animateTarget, callback); }
		...
		/// <returns></returns>
		public virtual void show(string animateTarget, Delegate callback, object scope) { _(animateTarget, callback, scope); }
		...
		/// <returns></returns>
		public virtual void hide(string animateTarget) { _(animateTarget); }
		...
		/// <returns></returns>
		public virtual void hide(string animateTarget, Delegate callback) { _(animateTarget, callback); }
		...
		/// <param name="scope">(optional) The scope in which to execute the callback</param>
		/// <returns></returns>
		public virtual void hide(string animateTarget, Delegate callback, object scope) { _(animateTarget, callback, scope); }
		...
		/// <returns>Ext.Window</returns>
		public virtual void anchorTo(object element, string position, System.Array offsets, bool monitorScroll) { _(element, position, offsets, monitorScroll); }
		...
		/// <param name="monitorScroll">(optional) true to monitor body scroll and reposition. If this parameter</param>
		/// <returns>Ext.Window</returns>
		public virtual void anchorTo(object element, string position, System.Array offsets, double monitorScroll) { _(element, position, offsets, monitorScroll); }
	...
	[JsAnonymous]
	public class WindowConfig : DotWeb.Client.JsDynamicBase {
