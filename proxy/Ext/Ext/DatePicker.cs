...
namespace Ext {
	...
	public class DatePicker : Ext.Component {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public DatePicker(string config) { C_(config); }
		...
		public string monthYearText { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class DatePickerConfig : DotWeb.Client.JsDynamicBase {
		/// <summary>  The text to display on the button that selects the current date (defaults to "Today")</summary>
		public string todayText { get { return _<string>(); } set { _(value); } }
