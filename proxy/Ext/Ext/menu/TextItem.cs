...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\TextItem.js</jssource>
	public class TextItem : Ext.menu.BaseItem {
		...
		/// <param name="config">If config is a string, it is used as the text to display, otherwise it</param>
		/// <returns></returns>
		public TextItem(string config) { C_(config); }
		/// <summary>
	...
	[JsAnonymous]
	public class TextItemConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The text to display for this item (defaults to '')</summary>
		public string text { get { return _<string>(); } set { _(value); } }
