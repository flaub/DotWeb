...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\ColorItem.js</jssource>
	public class ColorItem : Ext.menu.Adapter {
		...
		/// <returns></returns>
		public ColorItem(object config) { C_(config); }
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <returns></returns>
		public ColorItem(Ext.Component component) { C_(component); }
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public ColorItem(Ext.Component component, object config) { C_(component, config); }
		/// <summary>
		...
		/// <returns></returns>
		public ColorItem(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public ColorItem(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static ColorItem prototype { get { return S_<ColorItem>(); } set { S_(value); } }

		/// <summary>The reference to the constructor function</summary>
		public static Delegate constructor { get { return S_<Delegate>(); } set { S_(value); } }

		/// <summary>The reference to the class that this class inherits from</summary>
		public static Ext.menu.Adapter superclass { get { return S_<Ext.menu.Adapter>(); } set { S_(value); } }

		/// <summary>The Ext.ColorPalette object</summary>
		public Ext.ColorPalette palette { get { return _<Ext.ColorPalette>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class ColorItemConfig : DotWeb.Client.JsAccessible {
