...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\ColorItem.js</jssource>
	public class ColorItem : Ext.menu.Adapter {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public ColorItem(string config) { C_(config); }
	...
	[JsAnonymous]
	public class ColorItemConfig : DotWeb.Client.JsDynamicBase {
