...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\CheckItem.js</jssource>
	public class CheckItem : Ext.menu.Item {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public CheckItem(string config) { C_(config); }
		...
		/// </summary>
		public string group { get { return _<string>(); } set { _(value); } }
		...
		public string groupClass { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class CheckItemConfig : DotWeb.Client.JsDynamicBase {
