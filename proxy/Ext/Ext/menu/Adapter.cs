...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\Adapter.js</jssource>
	public class Adapter : Ext.menu.BaseItem {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Adapter(string config) { C_(config); }
	...
	[JsAnonymous]
	public class AdapterConfig : DotWeb.Client.JsDynamicBase {
