...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\menu\Separator.js</jssource>
	public class Separator : Ext.menu.BaseItem {
		...
		/// <returns></returns>
		public Separator(object config) { C_(config); }
		/// <summary>
		...
		/// <returns></returns>
		public Separator(Ext.Element config) { C_(config); }
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Separator(System.String config) { C_(config); }
	...
	[JsAnonymous]
	public class SeparatorConfig : DotWeb.Client.JsAccessible {
		/// <summary> The default CSS class to use for separators (defaults to "x-menu-sep")</summary>
