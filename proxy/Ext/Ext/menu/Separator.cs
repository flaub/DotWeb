...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\Separator.js</jssource>
	public class Separator : Ext.menu.BaseItem {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Separator(string config) { C_(config); }
	...
	[JsAnonymous]
	public class SeparatorConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The default CSS class to use for separators (defaults to "x-menu-sep")</summary>
		public string itemCls { get { return _<string>(); } set { _(value); } }
