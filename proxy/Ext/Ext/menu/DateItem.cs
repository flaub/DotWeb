...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\menu\DateItem.js</jssource>
	public class DateItem : Ext.menu.Adapter {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public DateItem(string config) { C_(config); }
	...
	[JsAnonymous]
	public class DateItemConfig : DotWeb.Client.JsDynamicBase {
