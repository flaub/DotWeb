...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\TriggerField.js</jssource>
	public class TriggerField : Ext.form.TextField {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TriggerField(System.String config) { C_(config); }
	...
	[JsAnonymous]
	public class TriggerFieldConfig : DotWeb.Client.JsAccessible {
