...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\FieldSet.js</jssource>
	public class FieldSet : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FieldSet(string config) { C_(config); }
		...
		public string checkboxName { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class FieldSetConfig : DotWeb.Client.JsDynamicBase {
