...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\NumberField.js</jssource>
	public class NumberField : Ext.form.TextField {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public NumberField(string config) { C_(config); }
		...
		public string decimalSeparator { get { return _<string>(); } set { _(value); } }
		...
		public string nanText { get { return _<string>(); } set { _(value); } }

		/// <summary>The base set of characters to evaluate as valid numbers (defaults to '0123456789').</summary>
		public string baseChars { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class NumberFieldConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The default CSS class for the field (defaults to "x-form-field x-form-num-field")</summary>
		public string fieldClass { get { return _<string>(); } set { _(value); } }
