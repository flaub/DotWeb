...
namespace Ext.form {
	...
	public class Label : Ext.BoxComponent {
		...
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public Label(string config) { C_(config); }
		/// <summary>
		///     Creates a new Label
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		...
		public string forId { get { return _<string>(); } set { _(value); } }
		...
		public string html { get { return _<string>(); } set { _(value); } }
		...
		/// <returns>Label</returns>
		public virtual void setText(string text, bool encode) { _(text, encode); }
	...
	[JsAnonymous]
	public class LabelConfig : DotWeb.Client.JsDynamicBase {
