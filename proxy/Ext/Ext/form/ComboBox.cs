...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\Combo.js</jssource>
	public class ComboBox : Ext.form.TriggerField {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public ComboBox(string config) { C_(config); }
		...
		/// <returns></returns>
		public virtual void setValue(string value) { _(value); }
		...
		/// <returns>Boolean</returns>
		public virtual void selectByValue(string value) { _(value); }
		...
		/// <returns>Boolean</returns>
		public virtual void selectByValue(string value, bool scrollIntoView) { _(value, scrollIntoView); }
		...
		/// <returns></returns>
		public virtual void doQuery(string query) { _(query); }
		...
		/// <returns></returns>
		public virtual void doQuery(string query, bool forceAll) { _(query, forceAll); }
	...
	[JsAnonymous]
	public class ComboBoxConfig : DotWeb.Client.JsDynamicBase {
