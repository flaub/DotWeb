...
namespace Ext.form {
	...
	public class Checkbox : Ext.form.Field {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Checkbox(string config) { C_(config); }
		...
		public string checkedCls { get { return _<string>(); } set { _(value); } }
		...
		public string focusCls { get { return _<string>(); } set { _(value); } }
		...
		public string mouseDownCls { get { return _<string>(); } set { _(value); } }
		...
		public string boxLabel { get { return _<string>(); } set { _(value); } }
		...
		public string inputValue { get { return _<string>(); } set { _(value); } }
		...
		/// <param name="chckd">True, 'true', '1', or 'on' to check the checkbox, any other value will uncheck it.</param>
		/// <returns></returns>
		public virtual void setValue(string chckd) { _(chckd); }
	...
	[JsAnonymous]
	public class CheckboxConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The CSS class to use when the control is checked (defaults to 'x-form-check-checked'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element.</summary>
		public string checkedCls { get { return _<string>(); } set { _(value); } }
