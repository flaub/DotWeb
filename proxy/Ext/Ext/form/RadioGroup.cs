...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\form\RadioGroup.js</jssource>
	public class RadioGroup : Ext.form.CheckboxGroup {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public RadioGroup(System.String config) { C_(config); }
	...
	[JsAnonymous]
	public class RadioGroupConfig : DotWeb.Client.JsAccessible {
		/// <summary> True to allow every item in the group to be blank (defaults to false). If allowBlank = false and no items are selected at validation time, {@link @blankText} will be used as the error text.</summary>
