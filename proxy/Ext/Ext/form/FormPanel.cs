...
namespace Ext.form {
	...
	///     });</code></pre><br>
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\Form.js</jssource>
	public class FormPanel : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public FormPanel(string config) { C_(config); }
		...
		public string formId { get { return _<string>(); } set { _(value); } }
		...
		/// </summary>
		public string labelAlign { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class FormPanelConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> (optional) The id of the FORM tag (defaults to an auto-generated id).</summary>
		public string formId { get { return _<string>(); } set { _(value); } }
