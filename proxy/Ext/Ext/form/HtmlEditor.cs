...
namespace Ext.form {
	...
	public class HtmlEditor : Ext.form.Field {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public HtmlEditor(string config) { C_(config); }
		...
		public string createLinkText { get { return _<string>(); } set { _(value); } }

		/// <summary>The default value for the create link prompt (defaults to http:/ /)</summary>
		public string defaultLinkValue { get { return _<string>(); } set { _(value); } }
		...
		/// <returns></returns>
		public virtual void cleanHtml(string html) { _(html); }
		...
		/// <returns></returns>
		public virtual void relayCmd(string cmd) { _(cmd); }
		...
		/// <returns></returns>
		public virtual void relayCmd(string cmd, string value) { _(cmd, value); }
		...
		/// <param name="value">(optional) The value to pass to the command (defaults to null)</param>
		/// <returns></returns>
		public virtual void relayCmd(string cmd, bool value) { _(cmd, value); }
		...
		/// <param name="cmd">The Midas command</param>
		/// <returns></returns>
		public virtual void execCmd(string cmd) { _(cmd); }
		...
		/// <param name="value">(optional) The value to pass to the command (defaults to null)</param>
		/// <returns></returns>
		public virtual void execCmd(string cmd, string value) { _(cmd, value); }
		...
		/// <param name="value">(optional) The value to pass to the command (defaults to null)</param>
		/// <returns></returns>
		public virtual void execCmd(string cmd, bool value) { _(cmd, value); }
		...
		/// <returns></returns>
		public virtual void insertAtCursor(string text) { _(text); }
	...
	[JsAnonymous]
	public class HtmlEditorConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> Enable the bold, italic and underline buttons (defaults to true)</summary>
		public bool enableFormat { get { return _<bool>(); } set { _(value); } }
