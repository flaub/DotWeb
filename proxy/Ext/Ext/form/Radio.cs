...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\Radio.js</jssource>
	public class Radio : Ext.form.Checkbox {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Radio(string config) { C_(config); }
	...
	[JsAnonymous]
	public class RadioConfig : DotWeb.Client.JsDynamicBase {
