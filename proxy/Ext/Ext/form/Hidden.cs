...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\Hidden.js</jssource>
	public class Hidden : Ext.form.Field {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Hidden(string config) { C_(config); }
	...
	[JsAnonymous]
	public class HiddenConfig : DotWeb.Client.JsDynamicBase {
