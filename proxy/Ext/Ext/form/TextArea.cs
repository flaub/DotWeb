...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\form\TextArea.js</jssource>
	public class TextArea : Ext.form.TextField {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TextArea(string config) { C_(config); }
	...
	[JsAnonymous]
	public class TextAreaConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The minimum height to allow when grow = true (defaults to 60)</summary>
		public double growMin { get { return _<double>(); } set { _(value); } }
