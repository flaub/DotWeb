...
namespace Ext.data {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\data\Record.js</jssource>
	public class Record : DotWeb.Client.JsNativeBase {
		...
		/// <returns>function</returns>
		public static Delegate create(System.Array o) { return S_<Delegate>(o); }
		...
		/// <returns>Record</returns>
		public virtual void copy(string id) { _(id); }
		...
		/// <returns>Boolean</returns>
		public virtual void isModified(string fieldName) { _(fieldName); }
