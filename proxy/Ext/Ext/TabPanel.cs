...
namespace Ext {
	...
	public class TabPanel : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public TabPanel(string config) { C_(config); }
		...
		public string tabPosition { get { return _<string>(); } set { _(value); } }
		...
		/// </summary>
		public string autoTabSelector { get { return _<string>(); } set { _(value); } }
		...
		/// <param name="item">The tab index, id or item</param>
		/// <returns></returns>
		public virtual void hideTabStripItem(string item) { _(item); }
		...
		/// <param name="item">The tab index, id or item</param>
		/// <returns></returns>
		public virtual void unhideTabStripItem(string item) { _(item); }
		...
		/// <returns></returns>
		public virtual void setActiveTab(string tab) { _(tab); }
		...
		/// <returns>Panel</returns>
		public virtual void getItem(string id) { _(id); }
		...
		/// <param name="tab">The id or tab Panel to activate</param>
		/// <returns></returns>
		public virtual void activate(string tab) { _(tab); }
	...
	[JsAnonymous]
	public class TabPanelConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> Set to true to do a layout of tab items as tabs are changed.</summary>
		public bool layoutOnTabChange { get { return _<bool>(); } set { _(value); } }
