...
namespace Ext {
	...
	/// </summary>
	/// <jssource>C:\home\src\proto\DotWeb\ExtJsParser\ext-2.2\source\widgets\tips\Tip.js</jssource>
	public class Tip : Ext.Panel {
		...
		/// <returns></returns>
		public Tip(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Tip(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Tip(System.String config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static Tip prototype { get { return S_<Tip>(); } set { S_(value); } }
		...
		/// <returns></returns>
		public virtual void showAt(System.Array xy) { _(xy); }
		...
		/// <returns></returns>
		public virtual void showBy(object el) { _(el); }
		...
		/// <returns></returns>
		public virtual void showBy(object el, System.String position) { _(el, position); }
	...
	[JsAnonymous]
	public class TipConfig : DotWeb.Client.JsAccessible {
		/// <summary> True to render a close tool button into the tooltip header (defaults to false).</summary>
