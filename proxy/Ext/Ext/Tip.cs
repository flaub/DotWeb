...
namespace Ext {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\tips\Tip.js</jssource>
	public class Tip : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Tip(string config) { C_(config); }
		...
		/// <returns></returns>
		public virtual void showBy(object el, string position) { _(el, position); }
	...
	[JsAnonymous]
	public class TipConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> True to render a close tool button into the tooltip header (defaults to false).</summary>
		public bool closable { get { return _<bool>(); } set { _(value); } }
