...
namespace Ext {
	...
	public class QuickTip : Ext.ToolTip {
		...
		/// <returns></returns>
		public QuickTip(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public QuickTip(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public QuickTip(string config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static QuickTip prototype { get { return S_<QuickTip>(); } set { S_(value); } }

		/// <summary>The reference to the constructor function</summary>
		public static Delegate constructor { get { return S_<Delegate>(); } set { S_(value); } }

		/// <summary>The reference to the class that this class inherits from</summary>
		public static Ext.ToolTip superclass { get { return S_<Ext.ToolTip>(); } set { S_(value); } }

		/// <summary>The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document).</summary>
		public object target { get { return _<object>(); } set { _(value); } }

		/// <summary>True to automatically use the element's DOM title value if available (defaults to false).</summary>
		public bool interceptTitles { get { return _<bool>(); } set { _(value); } }
		...
		/// </summary>
		/// <returns></returns>
		public virtual void register() { _(); }
		...
		/// <returns></returns>
		public virtual void register(object config) { _(config); }

		/// <summary>Removes this quick tip from its element and destroys it.</summary>
		/// <returns></returns>
		public virtual void unregister() { _(); }

		/// <summary>Removes this quick tip from its element and destroys it.</summary>
		/// <param name="el">The element from which the quick tip is to be removed.</param>
		/// <returns></returns>
		public virtual void unregister(string el) { _(el); }

		/// <summary>Removes this quick tip from its element and destroys it.</summary>
		/// <param name="el">The element from which the quick tip is to be removed.</param>
		/// <returns></returns>
		public virtual void unregister(DOMElement el) { _(el); }

		/// <summary>Removes this quick tip from its element and destroys it.</summary>
		/// <param name="el">The element from which the quick tip is to be removed.</param>
		/// <returns></returns>
		public virtual void unregister(Element el) { _(el); }
	...
	[JsAnonymous]
	public class QuickTipConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document).</summary>
		public object target { get { return _<object>(); } set { _(value); } }
