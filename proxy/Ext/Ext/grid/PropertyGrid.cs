...
namespace Ext.grid {
	...
	public class PropertyGrid : Ext.grid.EditorGridPanel {
		...
		/// <summary></summary>
		/// <returns></returns>
		public PropertyGrid() { C_(); }
		/// <summary></summary>
		/// <param name="config">The grid config object</param>
		/// <returns></returns>
		public PropertyGrid(object config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public PropertyGrid(Ext.Element config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public PropertyGrid(string config) { C_(config); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static PropertyGrid prototype { get { return S_<PropertyGrid>(); } set { S_(value); } }

		/// <summary>The reference to the constructor function</summary>
		public static Delegate constructor { get { return S_<Delegate>(); } set { S_(value); } }

		/// <summary>The reference to the class that this class inherits from</summary>
		public static Ext.grid.EditorGridPanel superclass { get { return S_<Ext.grid.EditorGridPanel>(); } set { S_(value); } }

		/// <summary>A data object to use as the data source of the grid (see {@link #setSource} for details).</summary>
		public object source { get { return _<object>(); } set { _(value); } }
		...
		///     </code></pre>
		/// </summary>
		public object customEditors { get { return _<object>(); } set { _(value); } }
		...
		/// </summary>
		/// <returns></returns>
		public virtual void setSource() { _(); }
		...
		/// <returns></returns>
		public virtual void setSource(object source) { _(source); }
		...
		public virtual void getSource() { _(); }
	...
	[JsAnonymous]
	public class PropertyGridConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> A data object to use as the data source of the grid (see {@link #setSource} for details).</summary>
		public object source { get { return _<object>(); } set { _(value); } }
