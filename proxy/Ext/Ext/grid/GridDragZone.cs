...
namespace Ext.grid {
	...
	public class GridDragZone : Ext.dd.DragZone {
		...
		/// <returns></returns>
		public GridDragZone(string id) { C_(id); }
		/// <summary>
		///     Valid properties for DDProxy in addition to those in DragDrop:
		///     resizeFrame, centerFrame, dragElId
		/// </summary>
		...
		/// <returns></returns>
		public GridDragZone(string id, string sGroup) { C_(id, sGroup); }
		/// <summary>
		///     Valid properties for DDProxy in addition to those in DragDrop:
		///     resizeFrame, centerFrame, dragElId
		/// </summary>
		...
		/// <returns></returns>
		public GridDragZone(string id, string sGroup, object config) { C_(id, sGroup, config); }
	...
	[JsAnonymous]
	public class GridDragZoneConfig : DotWeb.Client.JsDynamicBase {
