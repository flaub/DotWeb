...
namespace Ext.grid {
	...
	public class GridPanel : Ext.Panel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public GridPanel(string config) { C_(config); }
		...
		/// </summary>
		public string ddText { get { return _<string>(); } set { _(value); } }
		...
		public string autoExpandColumn { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class GridPanelConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The {@link Ext.data.Store} the grid should use as its data source (required).</summary>
		public Ext.data.Store store { get { return _<Ext.data.Store>(); } set { _(value); } }
