...
namespace Ext.grid {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\grid\EditorGrid.js</jssource>
	public class EditorGridPanel : Ext.grid.GridPanel {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public EditorGridPanel(string config) { C_(config); }
	...
	[JsAnonymous]
	public class EditorGridPanelConfig : DotWeb.Client.JsDynamicBase {
		/// <summary>  The number of clicks on a cell required to display the cell's editor (defaults to 2)</summary>
		public double clicksToEdit { get { return _<double>(); } set { _(value); } }
