...
namespace Ext.layout {
	...
	public class BorderLayoutClass : Ext.layout.ContainerLayout {
		...
		/// <returns></returns>
		public BorderLayoutClass() { C_(); }

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public static BorderLayoutClass prototype { get { return S_<BorderLayoutClass>(); } set { S_(value); } }
	...
	[JsAnonymous]
	public class BorderLayoutConfig : DotWeb.Client.JsDynamicBase {
