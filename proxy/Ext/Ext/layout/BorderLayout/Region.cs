...
namespace Ext.layout.BorderLayout {
	...
	public class Region : DotWeb.Client.JsNativeBase {
		...
		/// <returns></returns>
		public Region(object layout, object config, string position) { C_(layout, config, position); }
		...
		public string position { get { return _<string>(); } set { _(value); } }
	...
	[JsAnonymous]
	public class RegionConfig : DotWeb.Client.JsDynamicBase {
