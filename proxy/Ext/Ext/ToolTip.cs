...
namespace Ext {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\tips\ToolTip.js</jssource>
	public class ToolTip : Ext.Tip {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public ToolTip(string config) { C_(config); }
	...
	[JsAnonymous]
	public class ToolTipConfig : DotWeb.Client.JsDynamicBase {
		/// <summary> The target HTMLElement, Ext.Element or id to associate with this tooltip.</summary>
		public object target { get { return _<object>(); } set { _(value); } }
