...
namespace Ext {
	...
	public class Container : Ext.BoxComponent {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Container(string config) { C_(config); }
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		...
		/// <param name="component">The component reference or id to remove.</param>
		/// <returns></returns>
		public virtual void remove(string component) { _(component); }
		...
		/// <param name="autoDestroy">(optional) True to automatically invoke the removed Component's {@link Ext.Component#destroy} function.</param>
		/// <returns></returns>
		public virtual void remove(string component, bool autoDestroy) { _(component, autoDestroy); }
		...
		/// <returns>Ext.Component</returns>
		public virtual void getComponent(string id) { _(id); }
		...
		/// <param name="id"></param>
		/// <returns>Ext.Component</returns>
		public virtual void findById(string id) { _(id); }
		...
		/// <returns>Array</returns>
		public virtual void findByType(string xtype) { _(xtype); }
		...
		/// <returns>Array</returns>
		public virtual void find(string prop) { _(prop); }

		/// <summary>Find a component under this container at any level by property</summary>
		/// <param name="prop"></param>
		/// <param name="value"></param>
		/// <returns>Array</returns>
		public virtual void find(string prop, string value) { _(prop, value); }
	...
	[JsAnonymous]
	public class ContainerConfig : DotWeb.Client.JsDynamicBase {
