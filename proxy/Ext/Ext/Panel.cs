...
namespace Ext {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\proxy\ExtJsParser\ext-2.2\source\widgets\Panel.js</jssource>
	public class Panel : Ext.Container {
		...
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public Panel(string config) { C_(config); }
		...
		/// <returns>Ext.Button</returns>
		public virtual void addButton(string config) { _(config); }
		...
		/// <returns>Ext.Button</returns>
		public virtual void addButton(string config, Delegate handler) { _(config, handler); }
		...
		/// <returns>Ext.Button</returns>
		public virtual void addButton(string config, Delegate handler, object scope) { _(config, handler, scope); }
		...
		/// <returns></returns>
		public virtual void setTitle(string title) { _(title); }

		/// <summary>Sets the title text for the panel and optionally the icon class.</summary>
		/// <param name="title">The title text to set</param>
		/// <param name="iconCls">(optional) iconCls A user-defined CSS class that provides the icon image for this panel</param>
		/// <returns></returns>
		public virtual void setTitle(string title, string iconCls) { _(title, iconCls); }
		...
		/// <param name="config">A config object containing any of the following options:</param>
		/// <returns>Ext.Panel</returns>
		public virtual void load(string config) { _(config); }
	...
	[JsAnonymous]
	public class PanelConfig : DotWeb.Client.JsDynamicBase {
