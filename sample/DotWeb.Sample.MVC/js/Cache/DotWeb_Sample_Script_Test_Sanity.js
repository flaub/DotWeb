// Generated by H8 at: 9/8/2009 9:45:21 AM
...
DotWeb.Sample.Script.Test.Sanity = function() {
	this.$super.constructor();
};
DotWeb.Sample.Script.Test.Sanity.$extend(DotWeb.Client.JsScript);

DotWeb.Sample.Script.Test.Sanity.prototype.$ctor = function() {
	this.$super.$ctor.call(this);
	// nop
	// nop
	this.get_Window().alert("OK");
	// nop
	// nop
	return this;
};
...
$wnd.onload = function() {
	new DotWeb.Sample.Script.Test.Sanity().$ctor();
}
