...
{
	[TestFixture]
	public class GeneralTestsDebug : TestBase
	{
		public GeneralTestsDebug()
			: base("DotWeb.Translator.Test.Script", "H8.GeneralTests", Resources.GeneralDebug.ResourceManager, "Source", true) {
		}
