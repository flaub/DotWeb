...
{
	[TestFixture]
	public class ConditionalsTestDebug : TestBase
	{
		public ConditionalsTestDebug()
			: base("DotWeb.Translator.Test.Script", "H8.Conditionals", Resources.ConditionalsDebug.ResourceManager, "Source", true) {
		}
